...
// ---- 레벨 / 계급 ----
const MAX_LEVEL = 999999999;

const RANK_THRESHOLDS = [
  { rank: "E",   min: 1,  max: 400000000 },
  { rank: "D",   min: 400000001, max: 600000000 },
  { rank: "C",   min: 600000001, max: 800000000 },
  { rank: "B",   min: 800000001, max: 900000000 },
  { rank: "A",   min: 900000001, max: 940000000 },
  { rank: "S",   min: 940000001, max: 960000000 },
  { rank: "SS",  min: 960000001, max: 980000000 },
  { rank: "SSS", min: 980000001, max: 999999999 },
];
...
const ITEM_POOL = [
  ...
  { id: "sss_world_ender", name: "세계종말자", rankTier: "SSS", icon: null,
    ...
    active: { id: "world_end", name: "세계의 끝", power: 80, element: "dark",
      ...
      effect: null } },
  { id: "mbdr", name: "MBDR", rankTier: "THE GOD", icon: "public/assets/icons/mbdr.png",
    ...
    active: { id: "ewmbdr_a_ewbebdr", name: "Made And End", power: 999999999, element: "GOD",
      ...
      effect: { type: "spritesheet", src: "public/assets/effects/ewmbdr_a_ewbebdr.png", frameWidth: 4608, frameHeight: 192, frameCount: 24, fps: 60 } } },
];
