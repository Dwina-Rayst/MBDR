...
const ITEM_POOL = [
  { id: "a_flamethrower", name: "화염방사기", rankTier: "A", icon: "icons/flamethrower.png",
  ...
  { id: "ss_poseidon_trident", name: "포세이돈의 삼지창", rankTier: "SSS", icon: "icons/poseidon_trident.png",
    ...
    activeExtra: [
      { id: "sea_dragon_finale", name: "해룡의 화룡점정", power: 55, element: "water",
        conditions: [{ type: "rankAtLeast", rank: "SSS" }, { type: "usesPerMatch", max: 1 }],
        description: "계급 SSS 이상, 한 전투에서 딱 한 번만 사용 가능.",
