const {
  MAX_LEVEL, RANK_THRESHOLDS, STARTING_MONEY, GACHA_WEIGHTS,
...
function getItemPassives(itemIds) {
  ...
  result.damageReduction = Math.min(result.damageReduction, 0.6);
...
module.exports = {
  ...
  getItemPassives, ownsSkill, startingLoadout, rollGachaSkill,
};
