...
function getSkillElements(skillDef) {
  if (Array.isArray(skillDef.elements) && skillDef.elements.length > 0) return skillDef.elements;
  if (skillDef.element) return [skillDef.element];
  return ["none"];
}
