...
const { SKILL_POOL, ITEM_POOL, SELL_PRICE_BY_RANK } = require("./gameConfig");
...
async function main() {
  ...
  app.get("/api/gamedata", (req, res) => res.json({ skills: SKILL_POOL, items: ITEM_POOL, sellPriceByRank: SELL_PRICE_BY_RANK }));
